INSERT INTO library.users (Name, Email, Phone, City, Address)
...
INSERT INTO library.books (Title, Author, Publisher, ISBN, Publication_Date, Number_of_Pages, Contributor_Id, Current_Keeper_Id)
...
INSERT INTO library.loan_history (BookID, UserID, Loan_Date, Due_Date)
...
INSERT INTO library.reservation_queue (BookID, UserID, Reservation_Date)
...
INSERT INTO library.book_genres (BookID, Genres)
VALUES (1, 'Mystery'),
       (1, 'Thriller'),
       (1, 'Suspense'),
       (2, 'Romance'),
       ...
       (3, 'Science Fiction'),
       (3, 'Fantasy');
INSERT INTO library.book_tags (BookID, Tags)
VALUES (1, 'popular'),
       (1, 'historical'),
       (2, 'funny'),
       (3, 'popular'),
